...
🔗 **Live Site:** https://codedinpoetry.vercel.app/
...
- 📝 **Poetry** — emotions distilled into words  
- 💭 **Thoughts** — raw, unfiltered reflections  
...
```bash
git clone https://github.com/srutinadar26/Blog.git
cd Blog
npm install
npm run dev
```
...
This is a personal blog, but I welcome thoughtful feedback and suggestions.
